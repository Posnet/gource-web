// === File: src/core/ui/layout.cpp =============================================
// AGENT: PURPOSE    — Layout container for UI elements
...
void UILayout::drawBackground() {
    ...
    if(bgcolour.w > 0.0f) {
        ...
        r.color(ui->getBackgroundColour());
    }
...
UIResizeButton::UIResizeButton() {
    ...
    resizetex->setWrapStyle(GL_CLAMP_TO_EDGE);
...
void UIResizeButton::drawContent() {
    resizetex->bind();
    renderer().color(ui->getSolidColour());
