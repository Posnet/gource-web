// === File: src/core/ui/colour.cpp =============================================
// AGENT: PURPOSE    — Colour picker UI elements
...
void UIColour::drawContent() {
    ...
    if(active) {
        ...
        r.color(0.0f, 0.0f, 0.0f, 0.5f);
    }

    drawQuad(vec2(0.0f, 0.0f), vec2(14.0f, 14.0f), vec4(0.0f, 0.0f, 1.0f, 1.0f));

    r.color(colour->x, colour->y, colour->z, 1.0f);
